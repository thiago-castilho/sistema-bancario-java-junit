...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/thiago-castilho/sistema-bancario-java-junit/maven[GitHub Workflow Status]
